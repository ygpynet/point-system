...
export default class SubmitDecorationModal extends Modal {
  ...
  title() {
    ...
    return app.translator.trans('ygpynet-point-system.forum.submit.title_with', {
      family: app.translator.trans('ygpynet-point-system.forum.submit.family_' + family),
    });
  }
  ...
  content() {
    const t = (k: string, v?: any) => app.translator.trans('ygpynet-point-system.forum.submit.' + k, v);
    const type = String(this.attrs.type || '');
  ...
  async submit() {
    ...
    try {
      ...
      app.alerts.show({ type: 'success' }, app.translator.trans('ygpynet-point-system.forum.submit.submitted_alert'));
