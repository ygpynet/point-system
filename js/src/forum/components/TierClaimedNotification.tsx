...
export default class TierClaimedNotification extends Notification {
  ...
  content() {
    ...
    return app.translator.trans('ygpynet-point-system.forum.notifications.tier_claimed', { name });
  }
  ...
  excerpt() {
    ...
    return pts > 0
      ? app.translator.trans('ygpynet-point-system.forum.notifications.tier_excerpt', {
