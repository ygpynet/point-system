...
export default class PostTipListModal extends Modal {
  ...
  title() {
    return app.translator.trans('ramon-point-system.forum.tip_list.title');
  }
    ...
    if (tips.length === 0) {
      return (
        <div className="Modal-body">
          <p className="PostTipListModal-empty">{app.translator.trans('ramon-point-system.forum.tip_list.empty')}</p>
        </div>
      );
    }
    ...
    return (
      <div className="Modal-body">
        <div className="PostTipListModal-summary">
          ...
          <span>
            {app.translator.trans('ramon-point-system.forum.tip_list.total', {
