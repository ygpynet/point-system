...
export default class PostTippedNotification extends Notification {
  ...
  content() {
    ...
    const unit = app.forum.attribute('pointSystem.points_short') || app.translator.trans('ramon-point-system.forum.notifications.points_unit');
    return app.translator.trans('ramon-point-system.forum.notifications.post_tipped', { name, amount, unit });
  }
