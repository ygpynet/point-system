...
export default class ConfirmPurchaseModal extends Modal {
  ...
  title() {
    return this.attrs.title || app.translator.trans('ygpynet-point-system.forum.confirm.title');
  }

  content() {
    const t = (k: string, vars?: any) => app.translator.trans('ygpynet-point-system.forum.confirm.' + k, vars);
