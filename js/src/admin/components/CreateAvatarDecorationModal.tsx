...
export default class CreateAvatarDecorationModal extends Modal {
  ...
  title() {
    return app.translator.trans('ygpynet-point-system.admin.avatar.upload_title');
  }
  ...
  async commit() {
    ...
    try {
      ...
      app.alerts.show({ type: 'success' }, app.translator.trans('ygpynet-point-system.admin.avatar.uploaded'));
      this.hide();
    } catch (e: any) {
