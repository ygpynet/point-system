...
export default class CreateTitleDecorationModal extends Modal {
  ...
  title() {
    return app.translator.trans('ygpynet-point-system.admin.title.create_title');
  }

  content() {
    const draft = this.draft;
    const t = (k: string) => app.translator.trans('ygpynet-point-system.admin.title.' + k);
  ...
  async commit() {
    ...
    try {
      ...
      app.alerts.show({ type: 'success' }, app.translator.trans('ygpynet-point-system.admin.title.created'));
      this.hide();
    } catch (e: any) {
