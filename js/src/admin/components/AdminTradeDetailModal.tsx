...
export default class AdminTradeDetailModal extends Modal {
  ...
  title() {
    const t = (k: string, v?: any) => app.translator.trans('ygpynet-point-system.admin.trade_detail.' + k, v);
  ...
  async revert() {
    ...
    const t = (k: string) => app.translator.trans('ygpynet-point-system.admin.trade_detail.' + k);
