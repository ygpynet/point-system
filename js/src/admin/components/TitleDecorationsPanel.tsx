    ...
    return (
      <div className="PointSystemAdmin-section">
        <div className="PointSystemAdmin-section-header PointSystemAdmin-section-header--withAction">
          <div>
            <h2>{app.translator.trans('ygpynet-point-system.admin.title.title')}</h2>
            <p className="helpText">{app.translator.trans('ygpynet-point-system.admin.title.help')}</p>
          </div>
          <Button className="Button Button--primary" onclick={() => app.modal.show(CreateTitleDecorationModal, { onCreated: () => this.load() })}>
            <i className="fas fa-plus" /> {app.translator.trans('ygpynet-point-system.admin.title.create')}
          </Button>
        </div>

        {this.items.length === 0 ? (
          <p className="PointSystemAdmin-empty">{app.translator.trans('ygpynet-point-system.admin.title.none')}</p>
        ) : (
