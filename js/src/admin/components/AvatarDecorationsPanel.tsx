...
export default class AvatarDecorationsPanel extends Component {
  ...
  view() {
    ...
    const t = (k: string) => app.translator.trans('ygpynet-point-system.admin.avatar.' + k);
    ...
    return (
      <div className={`PointSystemAdmin-decoCard ${enabled ? '' : 'is-disabled'} ${listed ? '' : 'is-unlisted'}`}>
        ...
        <div className="PointSystemAdmin-decoCard-meta">
          ...
          {!listed && <span className="PointSystemAdmin-tag">{app.translator.trans('ygpynet-point-system.admin.availability.unlisted_tag')}</span>}
          {maxClaims != null && (
