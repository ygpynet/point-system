...
export default class CreateCoverDecorationModal extends Modal {
  ...
  title() {
    return app.translator.trans('ygpynet-point-system.admin.cover.upload_title');
  }
  ...
  content() {
    ...
    const ta = (k: string) => app.translator.trans('ygpynet-point-system.admin.avatar.' + k);
  ...
  async commit() {
    ...
    try {
      ...
      app.alerts.show({ type: 'success' }, app.translator.trans('ygpynet-point-system.admin.cover.uploaded'));
      this.hide();
    } catch (e: any) {
